...
const eloquentSuggestions = [
    ...
    { title: 'Values, Types, and Operators', page: 23 },
    { title: 'Program Structure', page: 35 },
    { title: 'Functions', page: 49 },
    { title: 'Data Structures: Objects and Arrays', page: 73 },
    { title: 'Higher-Order Functions', page: 98 },
    { title: 'The Secret Life of Objects', page: 117 },
    { title: 'Project: A Robot', page: 135 },
    { title: 'Bugs and Error Handling', page: 161 },
    { title: 'Regular Expressions', page: 176 },
    { title: 'Modules', page: 200 },
    { title: 'Asynchronous Programming', page: 342 },
    { title: 'Project: Skill-Sharing Website', page: 411 },
    { title: 'JavaScript and the Browser', page: 232 },
    { title: 'The Document Object Model', page: 241 },
    { title: 'Handling Events', page: 264 },
    { title: 'Project: A Platform Game', page: 284 },
    { title: 'Drawing on Canvas', page: 309 },
    { title: 'HTTP', page: 336 },
    { title: 'Forms', page: 354},
    { title: 'Project: A Paint Program', page: 371 },
    { title: 'Node.js', page: 388 },
    { title: 'Project: Skill-Sharing Website (Node.js)', page: 458 },
    ...
    { title: 'Testing', page: 163 },
    { title: 'Best Practices', page: 15 }
];
